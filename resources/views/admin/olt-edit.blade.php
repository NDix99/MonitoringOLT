        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4>Edit OLT Device: {{ $olt->name }}</h4>
                    ...
                    <form action="{{ route('admin.olts.update', $olt) }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                           id="name" name="name" value="{{ old('name', $olt->name) }}" required>
                                    @error('name')
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('community_string') is-invalid @enderror" 
                                           id="community_string" name="community_string" value="{{ old('community_string', $olt->community_string) }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('snmp_port') is-invalid @enderror" 
                                           id="snmp_port" name="snmp_port" value="{{ old('snmp_port', $olt->snmp_port) }}" 
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('snmp_version') is-invalid @enderror" 
                                        ...
                                        <option value="1" {{ old('snmp_version', $olt->snmp_version) == 1 ? 'selected' : '' }}>SNMP v1</option>
                                        <option value="2" {{ old('snmp_version', $olt->snmp_version) == 2 ? 'selected' : '' }}>SNMP v2c</option>
                                        <option value="3" {{ old('snmp_version', $olt->snmp_version) == 3 ? 'selected' : '' }}>SNMP v3</option>
                                    </select>
                                    @error('snmp_version')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('polling_interval') is-invalid @enderror" 
                                           id="polling_interval" name="polling_interval" value="{{ old('polling_interval', $olt->polling_interval) }}" 
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="Optional description for this OLT device">{{ old('description', $olt->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Update OLT Device
                            </button>
                        </div>
                    </form>
                </div>
